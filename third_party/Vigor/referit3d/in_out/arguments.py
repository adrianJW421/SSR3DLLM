...
def parse_arguments(notebook_options=None):
    ...
    parser.add_argument('--lang-multilabel', type=bool, default=False)
    parser.add_argument('--multilabel-pretraining', type=bool, default=False)
    parser.add_argument('--cascading', type=bool, default=False)
    parser.add_argument('--no-pretrain-ordering', type=bool, default=False, help='whether to enable referential order in the pretraining stage')
    parser.add_argument('--order-len', type=int, default=4, help='predefined length of referential order')
    parser.add_argument('--disable-coor-loss', type=bool, default=False, help='for ablation study')
    parser.add_argument('--disable-text-loss', type=bool, default=False, help='for ablation study')
    parser.add_argument('--disable-multilabel-loss', type=bool, default=False, help='for ablation study')
    ...
    # Optional: load per-scene Mask3D features (object_queries) instead of PointNet++ encoder.
    parser.add_argument('--mask3d-feature-root', type=str, default=None,
                        help='If set, will load pre-extracted Mask3D features (sceneXXX.pt) and freeze PointNet++.')
    parser.add_argument('--mask3d-feature-root-test', type=str, default=None,
                        help='Optional separate Mask3D feature root for the test split. '
                             'If not set, falls back to --mask3d-feature-root.')
    parser.add_argument('--mask3d-feature-dim', type=int, default=None,
                        help='Dim of Mask3D object_queries; if None, defaults to object_latent_dim.')
    ...
    # Optional: use ScanNet200-based object classification head / loss instead of Vigor 607-class space.
    parser.add_argument('--use-scannet200-obj-cls', type=str2bool, default=False,
                        help='If True, disable original Vigor object cls loss and '
                             'use a ScanNet200-based classification head driven by gt_instance_classes.')
